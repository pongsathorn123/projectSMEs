...
class AllProject4 extends Component{
  ...
  constructor(props) {
    ...
    componentDidMount(){
        this.props.allProjectStore.showmanufacturing();
  ...
  selectedcategory(e) {
    ...
    console.log(e);
    this.props.allProjectStore.show6();
  }
...
export default inject('allProjectStore')(observer(AllProject4))
