...
class AllProject2 extends Component{
  ...
  constructor(props) {
    ...
    componentDidMount(){
        this.props.allProjectStore.showcommercial();
  ...
  selectedcategory(e) {
    ...
    console.log(e);
    this.props.allProjectStore.show4();
  }
...
export default inject('allProjectStore')(observer(AllProject2))
