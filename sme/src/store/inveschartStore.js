...
export class inveschartStore {
  ...
  async info() {
    ...
    const response = await instance.get(`/user/invester/info/${this.year}/${this.smesId}`);
    ...
    this.dataChart = [
      {
        เดือน: 'มกราคม', จำนวนคน: this.m1, 
      },
      {
        เดือน: 'กุมภาพันธ์', จำนวนคน: this.m2,
      },
      {
        เดือน: 'มีนาคม', จำนวนคน: this.m3,
      },
      {
        เดือน: 'เมษายน', จำนวนคน: this.m4,
      },
      {
        เดือน: 'พฤษภาคม', จำนวนคน: this.m5,
      },
      {
        เดือน: 'มิถุนายน', จำนวนคน: this.m6,
      },
      {
        เดือน: 'กรกฎาคม', จำนวนคน: this.m7,
      },
      {
        เดือน: 'สิงหาคม', จำนวนคน: this.m8,
      },
      {
        เดือน: 'กันยายน', จำนวนคน: this.m9,
      },
      {
        เดือน: 'ตุลาคม', จำนวนคน: this.m10,
      },
      {
        เดือน: 'พฤศจิกายน', จำนวนคน: this.m11,
      },
      {
        เดือน: 'ธันวาคม', จำนวนคน: this.m12,
      },
    ];
...
export default inveschartStore;
